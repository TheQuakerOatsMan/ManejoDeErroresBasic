	...
	*/
	private void initialize() {
		...
		*/
		...
		areaTrabajo.setBounds(42, 0, 1076, 253);
		...
		lineas.setBounds(0, 0, 40, 253);
		sp3 = new JScrollPane(lineas);
		sp3.setBounds(0, 0, 40, 253);
		...
		consola.setBounds(0, 255, 552, 409);
		...
		consolaS.setBounds(553, 255, 552, 409);

		sp2s = new JScrollPane(consolaS);
		sp2s.setBounds(553, 255, 552, 409);
